 ...
 */
public class DiplomaticAnalysis extends AbstractMixedContentElement {

    public static final String LOCAL_NAME = "diplomaticAnalysis";
    @NotNull
    ...
    public DiplomaticAnalysis() {
        this("");
    }

    public DiplomaticAnalysis(@NotNull String content) {
        super(content, LOCAL_NAME);
    }

    public DiplomaticAnalysis(@NotNull String content, @NotNull String facs, @NotNull String id, @NotNull String n) {
        this(content);
