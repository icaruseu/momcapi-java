...
public class XpathQueryTest {
    ...
    public void testQUERY_CEI_IDNO_ID() throws Exception {
        List<String> result = resource.listQueryResultStrings(XpathQuery.QUERY_CEI_IDNO_ID);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_CEI_IDNO_TEXT() throws Exception {
        List<String> result = resource.listQueryResultStrings(XpathQuery.QUERY_CEI_IDNO_TEXT);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_SAVED() throws Exception {
        List<String> result = resource.listQueryResultStrings(XpathQuery.QUERY_XRX_SAVED);
        assertEquals(result.size(), 1);
