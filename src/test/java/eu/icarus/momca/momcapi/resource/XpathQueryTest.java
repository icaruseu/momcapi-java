...
public class XpathQueryTest {
    ...
    public void testQUERY_ATOM_EMAIL() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_ATOM_EMAIL);
    ...
    public void testQUERY_ATOM_ID() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_ATOM_ID);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_CEI_BODY_IDNO_TEXT() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_CEI_BODY_IDNO_TEXT);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_CEI_ISSUED() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_CEI_ISSUED);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_CEI_TEXT() throws Exception {
        Nodes result = resource.queryContentAsNodes(XpathQuery.QUERY_CEI_TEXT);
        assertEquals(result.size(), 1);
    }
    ...
    public void testQUERY_CEI_WITNESS_ORIG_FIGURE() throws Exception {
        ...
        Nodes result = resource.queryContentAsNodes(XpathQuery.QUERY_CEI_WITNESS_ORIG_FIGURE);
    ...
    public void testQUERY_CEI__BODY_IDNO_ID() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_CEI_BODY_IDNO_ID);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_CONFIG_GROUP_NAME() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_CONFIG_GROUP_NAME);
    ...
    public void testQUERY_CONFIG_NAME() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_CONFIG_NAME);
    ...
    public void testQUERY_NAME() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_NAME);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_BOOKMARK() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_XRX_BOOKMARK);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_EMAIL() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_XRX_EMAIL);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_MODERATOR() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_XRX_MODERATOR);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_NAME() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_XRX_NAME);
        assertEquals(result.size(), 1);
    ...
    public void testQUERY_XRX_SAVED_ID() throws Exception {
        List<String> result = resource.queryContentAsList(XpathQuery.QUERY_XRX_SAVED_ID);
        assertEquals(result.size(), 1);
