...
public class CharterTest {
    ...
    @NotNull
    private static final AtomIdCharter CHARTER_ATOM_ID = new AtomIdCharter("tag:www.monasterium.net,2011:/charter/CH-KAE/Urkunden/KAE_Urkunde_Nr_1");
    @NotNull
    ...
    public void testGetCeiDate() throws Exception {
        ...
        assertEquals(charterWithDate.getCeiDate().get().toXML(), "<cei:date xmlns:cei=\"http://www.monasterium.net/NS/cei\" value=\"12471027\">1247-10-27</cei:date>");

        Charter charterWithDateRange = new Charter(new ExistResource(NAME, PARENT_URI, XML_CONTENT_DATERANGE));
        assertEquals(charterWithDateRange.getCeiDate().get().toXML(), "<cei:dateRange xmlns:cei=\"http://www.monasterium.net/NS/cei\" from=\"12020101\" to=\"12021231\">During 1202</cei:dateRange>");
    ...
    public void testGetCeiIdno() throws Exception {
        Charter charter = new Charter(resource);
        assertEquals(charter.getCeiIdno().toXML(), "<cei:idno xmlns:cei=\"http://www.monasterium.net/NS/cei\" id=\"KAE_Urkunde_Nr_1\">KAE, Urkunde Nr. 1</cei:idno>");
    }
    ...
    public void testGetCeiWitnessOrigFigures() throws Exception {
        ...
        Charter charter = new Charter(resource);
        List<CeiFigure> figures = charter.getCeiWitnessOrigFigures();
