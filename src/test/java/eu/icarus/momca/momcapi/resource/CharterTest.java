...
public class CharterTest {
    ...
    private static final Author ATOM_AUTHOR = new Author("user1.testuser@dev.monasterium.net");
    @NotNull
    private static final Idno CEI_IDNO = new Idno("KAE_Urkunde_Nr_1", "KAE, Urkunde Nr. 1");
    @NotNull
    private static final IdCharter CHARTER_ATOM_ID = new IdCharter("tag:www.monasterium.net,2011:/charter/CH-KAE/Urkunden/KAE_Urkunde_Nr_1");
    @NotNull
    ...
    public void testGetCeiWitnessOrigFigures() throws Exception {
        ...
        Charter charter = new Charter(resource);
        List<Figure> figures = charter.getCeiWitnessOrigFigures();
    ...
    public void testGetIdno() throws Exception {
        Charter charter = new Charter(resource);
        assertEquals(charter.getIdno().toXML(), CEI_IDNO.toXML());
    }
