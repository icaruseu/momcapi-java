...
public class CharterTest {
    ...
    @NotNull
    private static final IdCharter ID_CHARTER = new IdCharter("tag:www.monasterium.net,2011:/charter/CH-KAE/Urkunden/KAE_Urkunde_Nr_1");
    @NotNull
    ...
    public void testGetAuthor() throws Exception {
        Charter charter = new Charter(resource);
        assertEquals(charter.getAuthor().get().toXML(), AUTHOR.toXML());
    }
