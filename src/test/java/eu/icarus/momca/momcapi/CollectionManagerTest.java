...
public class CollectionManagerTest {
    ...
    public void testAddCollection1() throws Exception {
        ...
        assertEquals(coll.getId().getId(), new IdCollection(identifier).getId());
    ...
    public void testGetCollection() throws Exception {
        ...
        assertEquals(collection2.getId().getId(), "tag:www.monasterium.net,2011:/collection/emptycollection");
