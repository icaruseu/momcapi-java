...
public class CollectionManagerTest {
    ...
    public void testAddCollection1() throws Exception {
        ...
        assertEquals(coll.getId().toText(), new IdCollection(identifier).toText());
    ...
    public void testGetCollection() throws Exception {
        ...
        assertEquals(collection1.getId().toText(), "tag:www.monasterium.net,2011:/collection/AbteiEberbach");
        ...
        assertEquals(collection2.getId().toText(), "tag:www.monasterium.net,2011:/collection/emptycollection");
